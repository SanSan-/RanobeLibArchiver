...
async function showSettingsMenu () {
  ...
  menu.innerHTML = `<div class='popup is-hidden' data-type='side'>
    ...
    <div class='popup__inner'>
      <div class='popup__content scrollable' role='dialog' aria-modal='true' tabindex='-1'>
        <div class='x2_h'>
          ...
          <div class='x2_bl' id='common-settings-panel' style='flex-grow: 0'>
            <div class='zx_bz'>
              <div class='z5_p'>
                <div class='z5_b6'><span>Общие настройки</span></div>
              </div>
            </div>
            <div class='zx_bz'>
              <div class='z5_p'>
                <div class='z5_b6'>Объединять главы по томам</div>
                <span class='zx_hv'>
    ...
    'setting-download-by-volumes') === 'true' ? 'checked' : ''} />
            ...
            <div class='zx_bz'>
              <div class='z5_p'>
                <div class='z5_b6'>Скачать все главы</div>
                <span class='zx_hv'>
    ...
    'setting-download-all-chapters') === 'true' ? 'checked' : ''} />
            ...
            <div class='zx_bz' id='chapters-range-slider-panel' ${getSetting(
    'setting-download-all-chapters') === 'true' ? 'hidden' : ''}>
              <div class='z5_p'>
                <div class='z5_b6' style='width: 100%'>Диапазон глав</div>
          ...
          <div class='x2_bl scrollable'>
            <div class='zx_bz'>
              <div class='z5_p'>
                <div class='z5_b6'><span>Настройки PDF</span></div>
              </div>
            </div>
            <div class='zx_bz' id='pdf-settings-panel'>
              <div class='z5_p'>
                <div class='z5_b6'>Скачивать с картинками</div>
                <span class='zx_hv'>
    ...
    'setting-download-pdf-images') === 'true' ? 'checked' : ''} />
              ...
              <div class='z5_p'>
                <div class='z5_b6'>Размер шрифта заголовка Тома</div>
                <span class='zx_hv'>
    ...
    'setting-pdf-volume-font-size')}'/>
              ...
              <div class='z5_p'>
                <div class='z5_b6'>Размер шрифта заголовка Главы</div>
                <span class='zx_hv'>
    ...
    'setting-pdf-chapter-font-size')}'/>
              ...
              <div class='z5_p'>
                <div class='z5_b6'>Размер шрифта основного текста</div>
                <span class='zx_hv'>
